...
kubectl set image deployments/client-deployment server=edwardjryanjr/multi-client:$SHA
kubectl set image deployments/worker-deployment server=edwardjryanjr/multi-worker:$SHA
